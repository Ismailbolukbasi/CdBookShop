...
namespace cdbook
{
    public partial class BookInfo : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["id"]))
                {
                    ...
                    string query = "SELECT Title, Author, Publisher, PageNumber, CoverImage FROM Books WHERE BookID = @BookID";
        ...
        // Function to add the visited page to the last visited pages list in the session
